...
#
# Copyright © 2016 Mike Shultz <mike@mikeshultz.com>
...
class DaemonRunner:
    ...
    def __init__(self, app):
        ...
        self.daemon_context.stdout = open(app.stdout_path, 'a+b')
        self.daemon_context.stderr = open(app.stderr_path, 'a+b')
        #self.daemon_context.files_preserve [self.daemon_context.stdout, self.daemon_context.stderr]
